...
import AddWw from "../DialogCommon/AddWw";
import EditWw from "../DialogCommon/EditWw";
...
const TableWw: FC<RecentOrdersTableProps> = ({
  cryptoOrders,
  handleChangeLimit,
  handleChangePage,
  total,
...
TableWw.defaultProps = {
  cryptoOrders: [],
};

export default TableWw;
